...
export const desc: string =
  'Fetch and decrypt end-to-end encrypted secret named <name>';

export const builder: Builder = (yargs) =>
  yargs
    .options({
      ...baseOptions,
      output: { type: 'string', alias: 'o', conflicts: 'json' },
...
export const handler: Handler = async (argv) => {
  ...
  const { profile, name: secretName, vault: vaultName, json, output } = argv;
